...
// kebab signal name -> lucide component (see data.ts)
        ...
        <div className="tb-left">
          ...
          <div>
            ...
            <div className="tb-sub">
              <b>{ROWS.length} companies</b> ·{' '}
              {ROWS.reduce((s, r) => s + r.people.length, 0)} contacts · Week of
              Jul 7
            </div>
          </div>
        </div>
              ...
              <>
                <div className="dr-head">
                  ...
                  <div className="dr-meta">
                    ...
                    {r.size} employees <span className="cc">{r.cc}</span>
                  </div>
